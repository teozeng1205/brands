...
This script analyzes fare brands in the 3Victors Common Output dataset for US domestic markets, identifying the range of brands per airline and flagging Basic Economy using a multi-factor scoring system. It includes:
- Data cleaning and US domestic filtering
- Brand identification by airline and market
- Advance purchase pattern analysis (7, 14, 21 days)
- Basic Economy detection using price rank, refundability, change fee, and brand name
- Visualizations and summary statistics
- A deliverable table for mapping and reporting
